    ...
    builder: function(yargs) {
      return yargs
        .option("ropsten", {
          ...
          default: false,
          type: "boolean",
          describe: "Attach to the Ropsten network"
        })
        .option("local", {
          alias: "l",
          default: true,
          type: "boolean",
          describe: "Make the node local (instead of ropsten)"
        })
        .option("console", {
          alias: "c",
          default: true,
    ...
    builder: function(yargs) {
      return yargs
        ...
        .option("testnet", {
          ...
          default: false,
          type: "boolean",
          describe: "Connect to the testnet (if local=false)"
        })
        .option("console", {
          alias: "c",
          default: true,
...
function runGeth(argv) {
  startGeth(argv.local, argv.ropsten, argv.testnet, argv.console, argv.clean);
}
